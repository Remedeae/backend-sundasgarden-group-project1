  ...
  return (
    <div className={props.className}>
      <h3>
        ...
        {`${props.title} (${props.TaskItemType.length})`}
      </h3>
      <ul
        className={`${props.className}__list`} /* onClick={handleEditPopup} */
      >
        {props.TaskItemType.map((t, index) => (
          <li key={index}>
            <i
              className={props.completeIcon}
            ...
            <div className="task__action">
              ...
              <i
                className={props.trashIcon}
                onClick={() =>
                  props.handleDelete(index, props.TaskItemType, props.setTask)
                }
              ></i>
            </div>
          </li>
