...
function DailyCatItem() {
  ...
  return (
    <div className="catPic">
      <h2>
        <i className="fa-regular fa-heart"></i>Daily Cat
      </h2>
      <div className="img-container">
        {catImage && (
          <img
            src={catImage.url}
            alt="Your daily cat image" /* width={catImage.width} height={catImage.height} */
          />
        )}
        <p>
          <i className="fa-solid fa-camera"></i>Photo of the Day
        </p>
      </div>
    </div>
  );
