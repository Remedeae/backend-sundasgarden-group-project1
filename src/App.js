...
var _catPlaceholder = _interopRequireDefault(
  require("./assets/cat-placeholder.jfif")
);
...
function App() {
  ...
  var handleTaskChange = function handleTaskChange(e, field) {
    setNewTask(
      _objectSpread(
        _objectSpread({}, newTask),
        {},
        _defineProperty({}, field, e.target.value)
      )
    );
  };
  ...
  return /*#__PURE__*/ React.createElement(
    ...
    /*#__PURE__*/ React.createElement(_UlItem.default, {
      className: "toDo",
      TaskItemType: tasks,
      title: "Active Tasks",
      iconClassName: "",
